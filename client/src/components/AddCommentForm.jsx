...
const AddCommentForm = () => {
  ...
  return (
    <form className="shadow rounded px-8 pt-6 pb-4 mb-4">
      ...
      onChange={(e)=>setCommentText(e.target.value)}
        ...
        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none"
      ></textarea>
      <button onClick={()=>addComment()} className="bg-blue-500 hover:bg-blur-700 text-white font-bold py-2 px-4 rounded focus:outline-none ">
        Add Comment
      </button>
    </form>
  );
